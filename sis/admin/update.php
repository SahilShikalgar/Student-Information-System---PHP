...
';
			...
			echo '<h3 class="mx-auto"> Students Information </h3>';
			echo '</div>';
								...
								while($row = mysqli_fetch_array($res))
								{
									if($row['name']==$name && $row['standard']==$standard)
									{
										echo "<tr>";	
											...
											$btn=$row['roll_no'];
											//echo "<td><input type='submit' name='$btn' class='btn btn-success form-control'value='Update'></td>";
											echo "<td><a class='btn btn-info form-control' href='update_process.php'>Update</a></td>";
										echo "</tr>";
									}
								}
							...
							$res = mysqli_query($con,$sql);
								...
								while($row = mysqli_fetch_array($res))
								{
										echo "<tr>";	
											...
											$btn=$row['roll_no'];
											//echo "<td><input type='submit' name='$btn' class='btn btn-success form-control'value='Update'></td>";
											echo "<td><a class='btn btn-info form-control' href='update_process.php?roll_no=$btn'>Update</a></td>";
										echo "</tr>";
								}
